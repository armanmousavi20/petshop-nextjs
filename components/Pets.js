...
const pets = [{id:1 , category:'cat' , name:'kyba' , image: Pet1Img },
              ...
              {id:8 , category:'cat' , name:'yena' , image: Pet8Img },
...
const Pets = () => {
  const [petDetials , setPetDetails] = useState(pets[10]);
  const [petIndex , setPetIndex] = useState(10);

  const getPetDetails = (id) => {
     const pet = pets.find( (pet) => { return pet.id === id } );
     console.log(pet);
     setPetDetails(pet);
  }
            ...
            <div className='flex flex-col lg:flex-row'>
                ...
                <div className='flex-1 flex flex-col lg:flex-row' >
                  <div className='lg:w-[30%] flex flex-col justify-center 
                                  items-end pb-6 lg:py-2 mx-auto lg:mx-0'>
                    <div className='text-center text-white'>
                          <div className='text-[32px] capitalize'> {petDetials.category} </div>                            
                          <div className='uppercase text-[17px] mb-1'> ({petDetials.name}) </div> 
                          <div className='w-[150px] h-[150px] mx-auto lg:mx-0 border-4 
                                          border-white rounded-full'>
                               <Image src={petDetials.image} width={150} height={150} alt='' />
                          </div>
                    </div>
                  </div>
                  <div className='relative lg:w-[60%]  
                     ...
                     <div className='flex flex-wrap gap-4 justify-center 
                                     lg:justify-end lg:-mr-6
                                      '>
                         {pets.map( (pet,index) => {return <div key={index} 
                                                           ...
                                                           className='cursor-pointer relative'> 
                                                                 ...
                                                                 <Image src={pet.image} width={95} height={95} 
                                                                      alt='' draggable='false' />
                                                            </div>  } )}
                     </div>
