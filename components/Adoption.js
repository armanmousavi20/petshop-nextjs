...
const Adoption = () => {
  return <section className='bg-adoption bg-cover bg-center bg-no-repeat 
                             min-h-[760px] py-8 flex'>
               <div className='container mx-auto flex flex-col lg:flex-row
                               items-center justify-center gap-x-16' >
                     ...
                     <div className='flex-1 text-cream text-center max-w-md lg:text-left lg:max-w-none'>
                         ...
                         <p className='mb-6'>
                             Pet parenting and the increasing emotional bond that exists between owner 
                             and pet means that it's no longer just about the pet's satisfaction
                         </p>
                         <ul className='mb-[38px] flex flex-col gap-y-4
                                        lg:list-disc lg:pl-4'>
                            <li> Adoption </li>
                            <li> Frozen Raw </li>
